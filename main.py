...
imagemBase = cv2.resize(imagemBase, (int(imagemBase.shape[1] / 2), int(imagemBase.shape[0] / 2)))
...
agulha = cv2.resize(agulha, (int(agulha.shape[1] / 2), int(agulha.shape[0] / 2)))
...
# mostramos a imagem final com as localizações, ilustando os pinos de pé
